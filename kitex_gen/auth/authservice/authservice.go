...
func getRSAKeyHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	switch s := arg.(type) {
	case *streaming.Args:
		st := s.Stream
		req := new(auth.GetRSAKeyReq)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(auth.AuthService).GetRSAKey(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *GetRSAKeyArgs:
		success, err := handler.(auth.AuthService).GetRSAKey(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*GetRSAKeyResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newGetRSAKeyArgs() interface{} {
	return &GetRSAKeyArgs{}
}

func newGetRSAKeyResult() interface{} {
	return &GetRSAKeyResult{}
}

type GetRSAKeyArgs struct {
	Req *auth.GetRSAKeyReq
}

func (p *GetRSAKeyArgs) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetReq() {
		p.Req = new(auth.GetRSAKeyReq)
	}
	return p.Req.FastRead(buf, _type, number)
}

func (p *GetRSAKeyArgs) FastWrite(buf []byte) (n int) {
	if !p.IsSetReq() {
		return 0
	}
	return p.Req.FastWrite(buf)
...
func (p *GetRSAKeyArgs) Size() (n int) {
	if !p.IsSetReq() {
		return 0
	}
	return p.Req.Size()
...
func (p *GetRSAKeyArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *GetRSAKeyArgs) Unmarshal(in []byte) error {
	msg := new(auth.GetRSAKeyReq)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var GetRSAKeyArgs_Req_DEFAULT *auth.GetRSAKeyReq

func (p *GetRSAKeyArgs) GetReq() *auth.GetRSAKeyReq {
	if !p.IsSetReq() {
		return GetRSAKeyArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *GetRSAKeyArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *GetRSAKeyArgs) GetFirstArgument() interface{} {
	return p.Req
}

type GetRSAKeyResult struct {
	Success *auth.GetRSAKeyResp
}

var GetRSAKeyResult_Success_DEFAULT *auth.GetRSAKeyResp

func (p *GetRSAKeyResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(auth.GetRSAKeyResp)
	}
	return p.Success.FastRead(buf, _type, number)
}

func (p *GetRSAKeyResult) FastWrite(buf []byte) (n int) {
	if !p.IsSetSuccess() {
		return 0
	}
	return p.Success.FastWrite(buf)
...
func (p *GetRSAKeyResult) Size() (n int) {
	if !p.IsSetSuccess() {
		return 0
	}
	return p.Success.Size()
...
func (p *GetRSAKeyResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *GetRSAKeyResult) Unmarshal(in []byte) error {
	msg := new(auth.GetRSAKeyResp)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *GetRSAKeyResult) GetSuccess() *auth.GetRSAKeyResp {
	if !p.IsSetSuccess() {
		return GetRSAKeyResult_Success_DEFAULT
	}
	return p.Success
}

func (p *GetRSAKeyResult) SetSuccess(x interface{}) {
	p.Success = x.(*auth.GetRSAKeyResp)
}

func (p *GetRSAKeyResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *GetRSAKeyResult) GetResult() interface{} {
	return p.Success
}

func setAESKeyHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	switch s := arg.(type) {
	case *streaming.Args:
		st := s.Stream
		req := new(auth.SetAESKeyReq)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(auth.AuthService).SetAESKey(ctx, req)
		if err != nil {
			return err
		}
		return st.SendMsg(resp)
	case *SetAESKeyArgs:
		success, err := handler.(auth.AuthService).SetAESKey(ctx, s.Req)
		if err != nil {
			return err
		}
		realResult := result.(*SetAESKeyResult)
		realResult.Success = success
		return nil
	default:
		return errInvalidMessageType
...
func newSetAESKeyArgs() interface{} {
	return &SetAESKeyArgs{}
}

func newSetAESKeyResult() interface{} {
	return &SetAESKeyResult{}
}

type SetAESKeyArgs struct {
	Req *auth.SetAESKeyReq
}

func (p *SetAESKeyArgs) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetReq() {
		p.Req = new(auth.SetAESKeyReq)
	}
	return p.Req.FastRead(buf, _type, number)
}

func (p *SetAESKeyArgs) FastWrite(buf []byte) (n int) {
	if !p.IsSetReq() {
		return 0
	}
	return p.Req.FastWrite(buf)
...
func (p *SetAESKeyArgs) Size() (n int) {
	if !p.IsSetReq() {
		return 0
	}
	return p.Req.Size()
...
func (p *SetAESKeyArgs) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetReq() {
		return out, nil
	}
	return proto.Marshal(p.Req)
...
func (p *SetAESKeyArgs) Unmarshal(in []byte) error {
	msg := new(auth.SetAESKeyReq)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var SetAESKeyArgs_Req_DEFAULT *auth.SetAESKeyReq

func (p *SetAESKeyArgs) GetReq() *auth.SetAESKeyReq {
	if !p.IsSetReq() {
		return SetAESKeyArgs_Req_DEFAULT
	}
	return p.Req
}

func (p *SetAESKeyArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *SetAESKeyArgs) GetFirstArgument() interface{} {
	return p.Req
}

type SetAESKeyResult struct {
	Success *auth.SetAESKeyResp
}

var SetAESKeyResult_Success_DEFAULT *auth.SetAESKeyResp

func (p *SetAESKeyResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(auth.SetAESKeyResp)
	}
	return p.Success.FastRead(buf, _type, number)
}

func (p *SetAESKeyResult) FastWrite(buf []byte) (n int) {
	if !p.IsSetSuccess() {
		return 0
	}
	return p.Success.FastWrite(buf)
...
func (p *SetAESKeyResult) Size() (n int) {
	if !p.IsSetSuccess() {
		return 0
	}
	return p.Success.Size()
...
func (p *SetAESKeyResult) Marshal(out []byte) ([]byte, error) {
	if !p.IsSetSuccess() {
		return out, nil
	}
	return proto.Marshal(p.Success)
...
func (p *SetAESKeyResult) Unmarshal(in []byte) error {
	msg := new(auth.SetAESKeyResp)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *SetAESKeyResult) GetSuccess() *auth.SetAESKeyResp {
	if !p.IsSetSuccess() {
		return SetAESKeyResult_Success_DEFAULT
	}
	return p.Success
}

func (p *SetAESKeyResult) SetSuccess(x interface{}) {
	p.Success = x.(*auth.SetAESKeyResp)
}

func (p *SetAESKeyResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *SetAESKeyResult) GetResult() interface{} {
	return p.Success
}
...
func (p *kClient) GetRSAKey(ctx context.Context, Req *auth.GetRSAKeyReq) (r *auth.GetRSAKeyResp, err error) {
	var _args GetRSAKeyArgs
	_args.Req = Req
	var _result GetRSAKeyResult
	if err = p.c.Call(ctx, "GetRSAKey", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}

func (p *kClient) SetAESKey(ctx context.Context, Req *auth.SetAESKeyReq) (r *auth.SetAESKeyResp, err error) {
	var _args SetAESKeyArgs
	_args.Req = Req
	var _result SetAESKeyResult
	if err = p.c.Call(ctx, "SetAESKey", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
